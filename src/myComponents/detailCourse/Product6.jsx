                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>Create real-world native apps using React Native,Get up to speed with React 
                                    design principles and methodologies,Understand the terminology and concepts of Redux.
                                    React Native has a bright future. Because it is not only supported by Facebook but a huge 
                                    community of developers. According to the StackOverflow developer's survey, 2019 React Native 
                                    lovers are almost 62.5%. It clearly states that React Native is one of the most loved frameworks for app development.</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
