    ...
    return (
        <Box className={classes.component}> 
                <Box className={classes.container}>
                    ...
                    <img src="https://www.qtreetechnologies.in/images/linux-training.jpg" className={classes.image}/>
                        <ActionItems />
                    </Box>
                    <Box className={classes.rightContainer}>
                        <Typography>Linux basics</Typography>
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>Linux Mastery: Master the Linux Command Line in 11.5 Hours
                                ...
                                Install and Manage Open Source Software with Package Managers!</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
