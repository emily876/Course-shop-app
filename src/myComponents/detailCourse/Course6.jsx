    ...
    return (
        <Box className={classes.component}> 
                <Box className={classes.container}>
                    ...
                    <img src="http://www.clickode.com/wp-content/uploads/2016/02/deep-learning.jpg" className={classes.image}/>
                        <ActionItems />
                    </Box>
                    <Box className={classes.rightContainer}>
                        <Typography>Deep Learning Course</Typography>
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>Data Science: Deep Learning and Neural Networks in Python
                                ...
                                Code a neural network from scratch in Python and numpy</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
