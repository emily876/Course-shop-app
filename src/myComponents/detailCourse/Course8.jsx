    ...
    return (
        <Box className={classes.component}> 
                <Box className={classes.container}>
                    ...
                    <img src="https://www.wpbeginner.com/wp-content/uploads/2019/07/createonlinecoursewp.png" className={classes.image}/>
                        <ActionItems />
                    </Box>
                    <Box className={classes.rightContainer}>
                        <Typography>WordPress Course</Typography>
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>The Complete WordPress Website Business Course
                                ...
                                Create all kinds of commercial websites, using WordPress, to sell to clients</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
