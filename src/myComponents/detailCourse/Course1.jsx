    ...
    return (
        <Box className={classes.component}> 
                <Box className={classes.container}>
                    ...
                    <img src="https://www.blockchain101.org/wp-content/uploads/2016/01/Cryptocurrency-Course.jpg" className={classes.image}/>
                        <ActionItems />
                    </Box>
                    <Box className={classes.rightContainer}>
                        <Typography>BlockChain Fundamental</Typography>
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>A blockchain is a permanent, sequential list of transaction records 
                                        distributed over a network.Bitcoin and other cryptocurrencies use blockchain technology
                                   to record transactions. Blockchain for business applications can include recording of contracts, 
                                   medical records, monetary transactions and much more.</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
