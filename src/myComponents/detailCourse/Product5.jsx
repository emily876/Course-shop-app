    ...
    return (
        <Box className={classes.component}> 
                <Box className={classes.container}>
                    ...
                    <img src="https://storage.ning.com/topology/rest/1.0/file/get/8667507462?profile=RESIZE_710x" className={classes.image}/>
                        <ActionItems />
                    </Box>
                    <Box className={classes.rightContainer}>
                        <Typography>Java In-Depth: Become a Complete Java Engineer!</Typography>
                        ...
                        <Typography>
                            <span className={classes.price}>₹3624</span> &nbsp;&nbsp;&nbsp;
                            <span className={classes.greyTextColor}><strike>₹6040</strike></span>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>Java is a computer programming language developed by James 
                                Gosling at Sun Microsystems.Java technology is the foundation for nearly every type of networked application.
                                Java is a computer programming language developed by James Gosling at Sun Microsystems.
                                Java technology is the foundation for nearly every type of networked application and is the global standard 
                                for developing and delivering embedded applications, games, web content, and enterprise software.</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
