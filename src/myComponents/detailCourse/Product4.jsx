                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>Learn, Analyse and Implement Data Structure using C and C++. 
                                    Learn Recursion and Sorting.Develop your Analytical skills on Data Structure and use then efficiently.
                                    Mostly you will be needing DS and Algorithms for competitive programming and once you learn them, C++ 
                                    provide STL which will save loads of time. C++ is an OOP language.</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
