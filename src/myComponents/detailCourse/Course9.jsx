    ...
    return (
        <Box className={classes.component}> 
                <Box className={classes.container}>
                    ...
                    <img src="https://d3o9cyokn8bkvv.cloudfront.net/wp-content/uploads/2021/03/Software-development-Life-Cycle.jpg" className={classes.image}/>
                        <ActionItems />
                    </Box>
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>Software Development: Better Requirements Gathering Skills
                                ...
                                Handle 'Single Interviews', 'Group Interviews' and 'Focus Groups'.</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
