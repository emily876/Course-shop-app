                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>Learn Web Development by building 25 websites and mobile apps using HTML, CSS, Javascript, PHP, Python, MySQL & more!
                                    the coding and programming side of web site production as opposed to the web design side. It encompasses everything from a 
                                    simple page of HTML text to complex, feature-rich applications designed to be accessed from various Internet-connected devices.
                                    </TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
