    ...
    return (
        <Box className={classes.component}> 
                <Box className={classes.container}>
                    ...
                    <img src="https://freecoursesite.pro/wp-content/uploads/2020/11/docker-mastery-with-kubernetes-swarm-from-a-docker-captain-2020_5fb6c6a27c901.jpeg" className={classes.image}/>
                        <ActionItems />
                    </Box>
                    <Box className={classes.rightContainer}>
                        <Typography>Docker Course</Typography>
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow className={classes.smallText}>
                                    ...
                                    <TableCell>Docker Mastery: with Kubernetes +Swarm from a Docker Captain.
                                ...
                                Docker is a popular open-source containerization platform for software development.</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </Box>
